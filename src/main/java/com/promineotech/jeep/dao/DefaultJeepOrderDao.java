...
public class DefaultJeepOrderDao implements JeepOrderDao {
	...
	public Order saveOrder(Customer customer, Jeep jeep, Color color, Engine engine, Tire tire, BigDecimal price, List<Option> options) {
		...
		// calling generateInsertSql
		SqlParams params = generateInsertSql(customer, jeep, color, engine, tire, price);
		
		// creating keyholder (what actually is this?), calling update on template
	...
	//
	// copying CONTENTS of DefaultJeepOrderDao.source into here from
	// https://github.com/promineotech/Spring-Boot-Course-Student-Resources/blob/main/Source/DefaultJeepOrderDao.source
	//

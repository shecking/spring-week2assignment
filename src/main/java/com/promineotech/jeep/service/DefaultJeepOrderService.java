...
public class DefaultJeepOrderService implements JeepOrderService {
	...
	// createOrder method
	// why is this in both the default implementing service (this file) and the interface (JeepOrderService)?
	@Transactional
	public Order createOrder(OrderRequest orderRequest) {
		
		// calling methods listed below for each type, assigning to variables
	...
	// copying CONTENTS of DefaultJeepOrderService.source into here from
	// https://github.com/promineotech/Spring-Boot-Course-Student-Resources/blob/main/Source/DefaultJeepOrderService.source
